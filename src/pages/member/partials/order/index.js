...
const Order = ({member, setReloadInvoice}) => {
    ...
    const handleOrdersData = async () => {
        await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/order`, {
            params: {
                member: member.id
            },
            headers: {
    ...
    const handleOrderShow = async (id) => {
        await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/order/${id}`, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + localStorage.getItem('token')
            }
    ...
    const handleOrderDelete = async (id) => {
        await axios.delete(`${process.env.REACT_APP_API_ENDPOINT}/order/${id}`, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + localStorage.getItem('token')
            }
    ...
    const handleInvoiceSubmit = async (order) => {
        await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/invoice`, {
            ...
            axios.post(`${process.env.REACT_APP_API_ENDPOINT}/invoice`, {
                member: member.id,
                product: order.product.id,
    ...
    return <>
        ...
        <PreviewCard>
            <ReactDataTable data={orders} columns={Columns} expandableRows pagination/>
        </PreviewCard>
